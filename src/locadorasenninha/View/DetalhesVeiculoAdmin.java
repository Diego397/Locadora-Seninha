...
public class DetalhesVeiculoAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelPainelModeloCarroAdmin.setForeground(new java.awt.Color(0, 0, 0));
        ...
        painelModeloCarroDetalhesVeiculoLayout.setHorizontalGroup(
            ...
            .addGroup(painelModeloCarroDetalhesVeiculoLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(labelPainelModeloCarroAdmin, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        labelPainelCorAdmin.setForeground(new java.awt.Color(0, 0, 0));
        ...
        labelPainelPlacaAdmin.setForeground(new java.awt.Color(0, 0, 0));
        ...
        labelPainelTaxaDiariaAdmin.setForeground(new java.awt.Color(0, 0, 0));
        ...
        labelPainelTaxaDiariaAtrasoAdmin.setForeground(new java.awt.Color(0, 0, 0));
        ...
        labelPainelValorTotalDiariasAdmin.setForeground(new java.awt.Color(0, 0, 0));
        ...
        labelPainelValorTotalAluguelAdmin.setForeground(new java.awt.Color(0, 0, 0));
        ...
        labelPainelDataEmissaoAdmin.setForeground(new java.awt.Color(0, 0, 0));
        ...
        labelPainelCapacidadePassageirosAdmin.setForeground(new java.awt.Color(0, 0, 0));
        ...
        labelPainelCapacidadeBagagensAdmin.setForeground(new java.awt.Color(0, 0, 0));
