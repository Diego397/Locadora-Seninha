...
public class TelaInicial extends javax.swing.JFrame {
    ...
    private void buttonLoginFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {
        TelaLoginFuncionario novatela = new TelaLoginFuncionario();
        novatela.setVisible(true);
        this.setVisible(false);
    }

    private void buttonLoginAdministradorActionPerformed(java.awt.event.ActionEvent evt) {
